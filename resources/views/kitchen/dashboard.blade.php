...
@section('title', 'Dashboard Kitchen - ' . config('branding.app_name'))
@section('content')
<div class="page-container">
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <a href="{{ route('kitchen.ambil-bahan') }}" class="text-decoration-none">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <a href="{{ route('kitchen.update-stok') }}" class="text-decoration-none">
                <div class="card border-0 shadow-sm h-100 stat-card">
                    <div class="card-body text-center">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <a href="{{ route('kitchen.daily-clean') }}" class="text-decoration-none">
                <div class="card border-0 shadow-sm h-100 stat-card">
                    <div class="card-body text-center">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <a href="{{ route('kitchen.token-listrik') }}" class="text-decoration-none">
                <div class="card border-0 shadow-sm h-100 stat-card">
                    <div class="card-body text-center">
