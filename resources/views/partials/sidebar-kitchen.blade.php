...
<aside class="app-sidebar" id="appSidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a class="sidebar-link {{ request()->routeIs('kitchen.dashboard') ? 'active' : '' }}"
           href="{{ route('kitchen.dashboard') }}" data-page="dashboard">
            <i class="bi bi-speedometer2"></i>
            <span>Dashboard Kitchen</span>
        </a>

        <a class="sidebar-link {{ request()->routeIs('kitchen.update-stok') ? 'active' : '' }}"
           href="{{ route('kitchen.update-stok') }}" data-page="update_stok">
            <i class="bi bi-arrow-repeat"></i>
            <span>Update Stok</span>
        </a>

        <a class="sidebar-link {{ request()->routeIs('kitchen.ambil-bahan') ? 'active' : '' }}"
           href="{{ route('kitchen.ambil-bahan') }}" data-page="ambil_bahan">
            <i class="bi bi-box-arrow-right"></i>
            <span>Ambil Bahan Gudang</span>
        </a>

        <a class="sidebar-link {{ request()->routeIs('kitchen.daily-clean') ? 'active' : '' }}"
           href="{{ route('kitchen.daily-clean') }}" data-page="daily_clean">
            <i class="bi bi-camera"></i>
            <span>Daily Clean</span>
        </a>

        <a class="sidebar-link {{ request()->routeIs('kitchen.token-listrik') ? 'active' : '' }}"
           href="{{ route('kitchen.token-listrik') }}" data-page="token_listrik">
