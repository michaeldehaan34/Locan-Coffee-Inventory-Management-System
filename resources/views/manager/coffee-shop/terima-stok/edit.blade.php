    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-8">
            <div class="card border-0 shadow-sm">
                ...
                <form action="{{ route('manager.coffee-shop.terima-stok.update', $id) }}" method="POST" id="formUpdateStok">
                    @csrf
                    ...
                    <div class="card-footer bg-white border-top d-flex justify-content-between p-4">
                        <a href="{{ route('manager.coffee-shop.terima-stok.index') }}" class="btn btn-light border px-4">Batal</a>
