                    ...
                    <div class="card border-0 shadow-sm mb-4">
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted mb-0">
                                ...
                                Barang/Bahan dikelompokkan berdasarkan Master Bahan: Kategori → Kelompok → Daftar Barang/Bahan.
                            </p>
                        </div>
                    </div>

                    <form method="POST" action="{{ route('gudang.stok-masuk.store') }}" id="stokMasukForm" autocomplete="off">
                        @csrf
                        <div class="row mb-4">
