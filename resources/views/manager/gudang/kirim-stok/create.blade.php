...
@section('title', 'Tambah Ambil Stok - ' . config('branding.app_name'))
@section('content')
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-bottom pb-0 pt-4 px-4">
                    <h3 class="mb-3">
                        ...
                        Tambah Ambil Stok dari Gudang
                    </h3>
                </div>
                
                <form action="{{ session('role') === 'admin gudang' ? route('gudang.kirim-stok.store') : route('gudang.kirim-stok.store') }}" method="POST" id="formUpdateStok">
                    @csrf
                            ...
                            <div class="col-md-4 mb-3 mb-md-0">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-select" id="tujuan" name="tujuan" required>
                                        <option value="coffee_shop" {{ old('tujuan') == 'coffee_shop' ? 'selected' : '' }}>Bar</option>
                                        <option value="kitchen" {{ old('tujuan') == 'kitchen' ? 'selected' : '' }}>Kitchen</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4">
                                                                    ...
                                                                    @foreach($grp['items'] as $item)
                                                                        <div class="barang-card input-with-unit">
                                                                            ...
                                                                            <input type="number" 
                                                                                   ...
                                                                                   value="{{ old($item['kode']) }}" placeholder="0">
                    ...
                    <div class="card-footer bg-white border-top d-flex justify-content-between p-4">
                        ...
                        <button type="submit" class="btn btn-primary px-4 shadow-sm" id="btnSubmit">
                            <i class="bi bi-send me-2"></i>Ambil Stok
                        </button>
                    </div>
                </form>
            </div>
