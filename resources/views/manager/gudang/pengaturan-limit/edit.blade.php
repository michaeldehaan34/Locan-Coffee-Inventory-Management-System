...
<div class="page-container">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body d-flex flex-wrap justify-content-between align-items-center gap-2">
                    ...
                    <a href="{{ route('gudang.pengaturan-limit') }}" class="btn btn-outline-light btn-sm">
    ...
    <div class="row">
        <div class="col-12 col-lg-8 mx-auto">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <form method="POST" action="{{ route('gudang.pengaturan-limit.update', $bahan->id) }}">
                        @csrf
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="{{ route('gudang.pengaturan-limit') }}" class="btn btn-outline-light">Batal</a>
