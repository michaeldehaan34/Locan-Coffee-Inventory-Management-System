            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <div class="table-responsive">
                        <form id="bulkDeleteForm" method="POST" action="{{ route('headbar.riwayat.daily-clean.bulk-delete') }}">
                            @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex gap-1">
                                                    <a href="{{ route('headbar.riwayat.daily-clean.detail', $rec['id']) }}" class="btn btn-sm btn-outline-info">
...
function openBulkDeleteModal() {
    ...
    swalConfirm({
        ...
        showLoader: true,
        preConfirm: function () {
            return fetch("{{ route('headbar.riwayat.daily-clean.bulk-delete') }}", {
                method: 'POST',
                headers: {
                    'X-Requested-With': 'XMLHttpRequest',
                    'Accept': 'application/json'
