        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body d-flex flex-wrap justify-content-between align-items-center gap-2">
                    ...
                    <a href="{{ route('headbar.riwayat.update-stok') }}" class="btn btn-outline-secondary">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('headbar.update-stok.update', $id) }}" id="updateStokForm" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="row mb-4">
