...
<div class="page-container">
    ...
    <div class="card border-0 shadow-sm mb-3">
        <div class="card-body">
            <form method="GET" action="{{ route('headbar.riwayat.update-stok') }}" class="filter-form">
                ...
                <div class="d-flex flex-wrap gap-2 mt-3">
                    ...
                    <a href="{{ route('headbar.riwayat.update-stok') }}" class="btn btn-outline-secondary"><i class="bi bi-arrow-counterclockwise me-1"></i>Reset</a>
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <hr class="border-secondary mb-3">
                    <form method="GET" action="{{ route('headbar.riwayat.update-stok') }}" class="row g-3 align-items-end mb-3">
                        <div class="col-12 col-md-4">
...
function renderTable() {
    ...
    filtered.forEach(function (rec, i) {
        var tr = document.createElement('tr');
            ...
            '<a href="{{ route("headbar.update-stok.edit", 0) }}'.replace('/0', '/' + rec.id) + '" class="btn btn-outline-warning" title="Edit"><i class="bi bi-pencil"></i></a>' +
            '<a href="{{ route("headbar.update-stok.detail", 0) }}'.replace('/0', '/' + rec.id) + '" class="btn btn-outline-info" title="Detail"><i class="bi bi-eye"></i></a>' +
