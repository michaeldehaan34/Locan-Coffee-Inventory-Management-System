        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    ...
                    <p class="text-muted mb-0">Catat pengambilan stok dari Gudang ke Bar</p>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-muted mb-0">
                                Input jumlah bahan yang diambil dari Gudang. Kosongkan input atau isi 0 jika tidak ada pengambilan untuk bahan tersebut. Jumlah pengambilan tidak boleh melebihi Stok Gudang.
                                        ...
                                        <form method="POST" action="{{ route('headbar.coffee-shop.ambil-bahan.store') }}" id="updateStokForm">
