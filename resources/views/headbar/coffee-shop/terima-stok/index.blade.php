                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('headbar.coffee-shop.terima-stok.detail', ['id' => $row->id, 'source' => $row->source]) }}" class="btn btn-sm btn-outline-info" title="Detail">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                        @if($row->source !== 'ambil_bahan_gudang')
                                        <a href="{{ route('headbar.coffee-shop.terima-stok.edit', $row->id) }}" class="btn btn-sm btn-outline-warning" title="Edit">
                                            <i class="bi bi-pencil"></i>
                                        </a>
                                        <form action="{{ route('headbar.coffee-shop.terima-stok.delete', $row->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Hapus transaksi ini?');">
                                            @csrf
