    ...
    <div class="row justify-content-center">
        <div class="col-12 col-lg-8">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3 mb-md-0">
                            ...
                            <p class="mb-0 fw-bold">
                                {{ $record->pelaku }}<br>
                                <span class="text-muted small fw-normal">{{ $source === 'ambil_bahan_gudang' ? 'Kitchen' : 'Admin Gudang' }}</span>
                            </p>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <p class="mb-0 fw-bold">Kitchen</p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <p class="mb-0 fw-bold">
                                @if($record->receiver)
                                    {{ $record->receiver->nama_lengkap }} â€” {{ $record->receiver->role }}
                                @else
                                    Sistem (Legacy)
                                @endif
                            </p>
                ...
                <div class="card-footer bg-white border-top p-4 d-flex justify-content-end align-items-center">
                    <a href="{{ route('headkitchen.kitchen.riwayat.terima-stok.index') }}" class="btn btn-secondary px-4 me-2">Kembali</a>
                    
                    @if($record->status === 'pending' && $source === 'gudang_kirim')
                    <form action="{{ route('headkitchen.kitchen.terima-stok.proses', $record->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menerima stok ini? Stok yang diterima akan masuk ke inventory.');">
                        @csrf
                        <button type="submit" class="btn btn-success px-4">
                            <i class="bi bi-check-circle me-2"></i>Terima Stok
                        </button>
                    </form>
                    @endif
                </div>
