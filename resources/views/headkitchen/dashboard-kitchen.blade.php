...
@section('title', 'Dashboard Head Kitchen - ' . config('branding.app_name'))
@section('content')
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <h2 class="mb-0">
                        ...
                        Dashboard Head Kitchen
                    </h2>
                    <p class="text-muted mb-0">Selamat datang, {{ session('name') ?: session('username') }}! Berikut Ringkasan Stok Kitchen Terkini.</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <h5 class="mb-3 text-center">
                        ...
                        STOK BAHAN KITCHEN TERKINI
                    </h5>
                    <p class="text-muted small mb-3 text-center">Nilai stok terkini di lokasi Kitchen.</p>
