        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body d-flex flex-wrap justify-content-between align-items-center gap-2">
                    ...
                    <div>
                        <a href="{{ route('headkitchen.dashboard') }}" class="btn btn-outline-light btn-sm">
                            ...
                            <tbody>
                                @forelse ($limits as $i => $b)
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $b->limit_tipis }}</td>
                                        <td>
                                            <a href="{{ route('headkitchen.pengaturan-limit.edit', ['id' => $b->id]) }}" class="btn btn-sm btn-outline-light">
