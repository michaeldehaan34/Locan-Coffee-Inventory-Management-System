        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-body d-flex flex-wrap justify-content-between align-items-center gap-2">
                    ...
                    <a href="{{ route('headkitchen.riwayat.update-stok') }}" class="btn btn-outline-secondary">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body p-4">
                    ...
                    <form method="POST" action="{{ route('headkitchen.update-stok.update', $id) }}" id="updateStokForm" autocomplete="off">
                        @csrf
                        @method('PUT')
                        <div class="row mb-4">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('Kitchen') is-invalid @enderror" id="Kitchen" name="Kitchen"
                                    value="{{ old('Kitchen', ($default_data['Kitchen'] ?? '')) }}" required>
                                @error('Kitchen')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                        </div>
